...
define("require exports ../../core/tsSupport/declareExtendsHelper ../../core/tsSupport/decorateHelper ../../geometry ../../Graphic ../../core/Accessor ../../core/Evented ../../core/Handles ../../core/watchUtils ../../core/accessorSupport/decorators ../../layers/GraphicsLayer ../../symbols/SimpleFillSymbol ../../symbols/SimpleLineSymbol ../../symbols/SimpleMarkerSymbol ../../views/2d/draw/Draw ../../views/2d/draw/support/Box ../../views/2d/draw/support/GraphicMover ../../views/2d/draw/support/Reshape ./support/sketchUtils".split(" "),
    function (da, ea, B, q, r, m, C, D, S, E, p, T, A, F, v, U, G, V, H, n) {
        var I = function (f) {
                ...
                //
                q([p.property()], d.prototype, "canUndo", void 0);
                q([p.property()], d.prototype, "canRedo", void 0);

                q([p.property()], d.prototype, "complete", void 0);
                q([p.property()], d.prototype, "cancel", void 0);
                //
                q([p.property()], d.prototype, "undo", void 0);
                q([p.property()], d.prototype, "redo", void 0);
                return d = q([p.subclass()], d)
            }(p.declared(C,
            D)), W = function () {
                return function (f) {
        ...
        return function (f) {
            ...
            d.prototype.undo =
                function () {
                    this._operationHandle && this._operationHandle.canUndo() && this._operationHandle.undo()
                };
            d.prototype.redo = function () {
                this._operationHandle && this._operationHandle.canRedo() && this._operationHandle.redo()
            };
            ...
            d.prototype._updatePointOperation = function (c, a) {
                var b = this,  o= [], p = [], d = null, e = new m(c.geometry, this.updatePointSymbol);
                this._layer.add(e);
                ...
                }), this.view.on("key-down", function (a) {"z" === a.key ? h && h.undo() : "r" === a.key ? h && h.redo():
                "Escape" === a.key && (b.graphic.geometry !== c.geometry ? h && h.complete() : h && h.cancel())
                    ...
                    graphics: [e], view: this.view, callbacks: {
                        onGraphicMoveStart: function (a) {
                            p = [];
                            o.push({geometry: b.graphic.geometry});
                    ...
                    type: "update", complete: function () {
                        ...
                        if (h.canUndo()) {
                            var a = o.pop();
                            p.push({geometry: b.graphic.geometry});
                            b.graphic.geometry = a.geometry;
                            b._emitUndoEvent()
                        }
                    }, redo: function () {
                        if (h.canRedo()) {
            ...
            d.prototype._updatePolygonOperation = function (c, a) {
                ...
                }),k=d, g = [this.view.on("click", function (a) {
                ...
                }), this.view.on("key-down", function (a) {"z" === a.key ? f&& f.undo() : "r" === a.key ? f && f.redo():
            ...
            d.prototype._emitUndoEvent = function () {
                this.emit("undo", new fa(this.graphic.geometry))
            };
            d.prototype._emitRedoEvent = function () {
                this.emit("redo", new ga(this.graphic.geometry))
            };
